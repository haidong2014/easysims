    ...
    <div></div>
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
		    ...
		    <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="course" type="text" id="course" ltype="text"  value="<?php echo @$birthday ?>"  validate="{required:true,minlength:3,maxlength:10}" /></td>
                <td align="left"></td>
            </tr>
			<tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td"> 
                <textarea cols="100" rows="4" class="l-textarea" id="remarks" name="remarks"  value="<?php echo @$remarks ?>"  style="width:400px"></textarea>
                </td><td align="left"></td>
            </tr>
        </table>
		<br />
