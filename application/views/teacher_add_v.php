    ...
    <div></div>
        <table cellpadding="0" cellspacing="0" class="l-table-edit" >
		    <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="teacher_no" type="text" id="teacher_no" ltype="text" validate="{required:true,minlength:3,maxlength:10}" /></td>
                <td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">教师姓名:</td>
                <td align="left" class="l-table-edit-td"><input name="teacher_name" type="text" id="teacher_name" ltype="text" validate="{required:true,minlength:3,maxlength:10}" /></td>
                <td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td" valign="top">性别:</td>
                <td align="left" class="l-table-edit-td">
                    <input id="sex" type="radio" name="sex" value="1" checked="checked" /><label for="rbtnl_0">男</label>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="birthday" type="text" id="birthday" ltype="date" validate="{required:true}" />
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td" valign="top">专/兼职:</td>
                <td align="left" class="l-table-edit-td">
                    <input id="property" type="radio" name="property" value="1" checked="checked" /><label for="rbtnl_0">专</label>
					<input id="rbtn2_1" type="radio" name="rbtn2" value="2" /><label for="rbtnl_1">兼</label>
                </td><td align="left"></td>
            </tr>
		    <tr>
                <td align="right" class="l-table-edit-td">任课科目:</td>
                <td align="left" class="l-table-edit-td"><input name="course" type="text" id="course" ltype="text" validate="{required:true,minlength:3,maxlength:10}" /></td>
                <td align="left"></td>
            </tr>
			<tr>
                <td align="right" class="l-table-edit-td">手机:</td>
                <td align="left" class="l-table-edit-td"><input name="telephone" type="text" id="telephone" ltype="text" validate="{minlength:11,maxlength:11}" /></td>
                <td align="left"></td>
            </tr>
             <tr>
                <td align="right" class="l-table-edit-td">Email:</td>
                <td align="left" class="l-table-edit-td"><input name="email" type="text" id="email" ltype="text" validate="{email:true}" /></td>
                <td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td" valign="top">系统用户:</td>
                <td align="left" class="l-table-edit-td">
                     <input id="system_user" type="checkbox" name="system_user" checked="checked" /><label for="CheckBoxList1_0">有效</label>
                </td><td align="left"></td>
            </tr>  
            <tr>
                <td align="right" class="l-table-edit-td">备注:</td>
                <td align="left" class="l-table-edit-td"> 
                <textarea cols="100" rows="4" class="l-textarea" id="remarks" name="remarks" style="width:400px"></textarea>
                </td><td align="left"></td>
            </tr>
        </table>
		<br />
