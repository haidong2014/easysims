...
class Job_m extends MY_Model
{
    ...
    {
        $this->db->select('t1.job_id,t1.job_company,t1.job_city,t1.job_business,t1.job_address,t1.job_telephone,' .
    ...
    public function getOne($job_id){
        $this->db->select('job_id,job_company,job_city,job_business,job_address,job_telephone,job_contacts,job_post,' .
