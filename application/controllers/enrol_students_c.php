...
class Enrol_students_c extends MY_Controller {
    ...
    public function index()
    {
        ...
        foreach($classData as &$temp){
            $temp['class_no']="<a href=\"".SITE_URL."/enrol_students_c/student_lst/".$temp['class_no']."\">".$temp['class_no']."</a>";
        }
    ...
    public function search_class()
    {
        ...
        $user = $this->session->all_userdata();
        log_message('info', "enrol_students_c search_class user:".var_export($user,true));
        log_message('info', "enrol_students_c search_class post:".var_export($_POST,true));
