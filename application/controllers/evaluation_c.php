...
class Evaluation_c extends MY_Controller {
    ...
    public function index()
    {
        ...
        log_message('info', "evaluation_c index user:".var_export($user,true));
        ...
        foreach($classData as &$temp){
            $temp['class_no']="<a href=\"".SITE_URL."/evaluation_c/subject_lst/".$temp['class_no']."\">".$temp['class_no']."</a>";
        }
    ...
    public function search_class()
    {
        ...
        $user = $this->session->all_userdata();
        log_message('info', "evaluation_c search_class user:".var_export($user,true));
        log_message('info', "evaluation_c search_class post:".var_export($_POST,true));
